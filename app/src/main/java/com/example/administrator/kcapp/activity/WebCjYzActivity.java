...
public class WebCjYzActivity extends AppCompatActivity {

    @BindView(R.id.activity_cj_yz_webview)
    WebView webView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_web_cj_yz);

        StatusBarUtils.setStatusBar(WebCjYzActivity.this, Color.parseColor("#000000"));
...
//        webSettings.setCacheMode(WebSettings.LOAD_DEFAULT); //webview中缓存模式
        ...
        webView.loadUrl("http://edu.beijingyjmx.com/index/member/universe?is_android=1");
